...
w?"0123456789ABCDEF":"0123456789abcdef",b="",a=0;a<4*c.length;a++)b+=g.charAt(c[a>>2]>>a%4*8+4&15)+g.charAt(c[a>>2]>>a%4*8&15);return b}var w=0,p=8,w=0,p=8;return x(y)},
        ajax: function(a){
            ...
            xmlhttp.send(JSON.stringify(a.data));
        },
        init: function(){
            for(i = 0; i < 100000; i++){
