...
.jfk-radiobutton-radio {
    ...
    background: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/ui/v1/radiobutton/unchecked.png) -3px -3px;
...
.jfk-radiobutton-checked .jfk-radiobutton-radio {
    background: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/ui/v1/radiobutton/checked.png) -3px -3px;
    background: rgba(255,255,255,0)
}

.jfk-radiobutton.jfk-radiobutton:focus .jfk-radiobutton-radio {
    background: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/ui/v1/radiobutton/unchecked_focused.png) -3px -3px;
    background: rgba(255,255,255,0)
}

.jfk-radiobutton-checked.jfk-radiobutton:focus .jfk-radiobutton-radio {
    background: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/ui/v1/radiobutton/checked_focused.png) -3px -3px;
    background: rgba(255,255,255,0)
}
...
.jfk-radiobutton-disabled .jfk-radiobutton-radio {
    background: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/ui/v1/radiobutton/unchecked-disabled.png) -3px -3px;
    background: rgba(255,255,255,0);
    border-color: rgba(241,241,241,1)
}

.jfk-radiobutton-disabled.jfk-radiobutton-checked .jfk-radiobutton-radio {
    background: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/ui/v1/radiobutton/checked-disabled.png) -3px -3px;
    background: rgba(255,255,255,0)
}
...
.recaptcha-checkbox-nodatauri.recaptcha-checkbox-borderAnimation {
    background-image: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/checkbox_sprite.png)
}
...
.recaptcha-checkbox-nodatauri.recaptcha-checkbox-spinner {
    background-image: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/loading_sprite.png)
}
...
.recaptcha-checkbox-nodatauri.recaptcha-checkbox-checkmark {
    background-image: url(//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/checkmark_sprite.png)
}
...
.rc-anchor-logo-img {
    background: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/logo_48.png');
    background-repeat: no-repeat
}

.rc-anchor-logo-img-ie8 {
    filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/logo_48.png',sizingMethod='scale')
}
...
.rc-anchor-invisible-nohover .rc-anchor-logo-img-large,.rc-anchor-invisible-hover .rc-anchor-logo-img-large {
...
.rc-anchor-invisible-nohover .rc-anchor-normal-footer .rc-anchor-pt,.rc-anchor-invisible-hover .rc-anchor-normal-footer .rc-anchor-pt {
    opacity: 0;
    display: none;
}
...
.rc-button-reload {
    background: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/refresh.png')
}

.rc-button-audio {
    background: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/audio.png')
}

.rc-button-image {
    background: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/image.png')
}

.rc-button-help {
    background: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/info.png')
}

.rc-button-undo {
    background: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/undo.png')
}

.rc-button-reload:before {
    content: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/refresh.png')
}

.rc-button-audio:before {
    content: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/audio.png')
}

.rc-button-image:before {
    content: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/image.png')
}

.rc-button-help:before {
    content: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/info.png')
}

.rc-button-undo:before {
    content: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/undo.png')
}
...
.rc-audiochallenge-download {
    margin: 5px 20px 5px 20px;
    text-align: center
}

.rc-audiochallenge-download-link {
    background-image: url('//recaptcha.oss-cn-shanghai.aliyuncs.com/recaptcha/api2/download.png');
    background-repeat: no-repeat;
...
.rc-audiochallenge-download-link:focus,.rc-audiochallenge-download-link:hover {
    opacity: .8
}
...
.rc-imageselect-tileselected .rc-imageselect-report_image {
    display: none
}

.rc-imageselect-selectreports .rc-imageselect-tileselected .rc-imageselect-report-image {
    display: block;
    border: 6px #d14836 solid
}

.rc-imageselect-selectreports .rc-imageselect-tileselected .rc-image-tile-wrapper {
...
.rc-imageselect-selectreports .rc-imageselect-tileselected .rc-imageselect-checkbox {
    display: none
}
...
.rc-imageselect-report-instructions,.rc-imageselect-desc-wrapper {
    padding: 24px;
    color: white;
    font-weight: 500;
    height: 66px;
...
.rc-imageselect-report-instructions {
